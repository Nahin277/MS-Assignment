---
title: "MS-501 Assignment"
author:
- name: Kazi Sabbir Ahmad Nahin
...
###Required Codes and Graphs for Question 1

##Specifying the distribution of Y(i)
```{r}
...
##EM algorithm for estimating the parameter(iii)
```{r}
em_mle<-function(t0)
{
  theta_initial<-t0
...
```{r}
#Curve fitting with MLE
hist(y,breaks=10,freq=FALSE,main = "Histogram of Y")
curve(dexp(x,0.09764292),0,50,add=TRUE)
#Curve fitting with EM estimate
hist(y,breaks=10,freq=FALSE,main = "Histogram of Y")
